...
ActiveRecord::Schema.define(:version => 20140129100000) do
  ...
  create_table "car_translations", :force => true do |t|
    t.integer  "car_id"
  ...
  add_index "car_translations", ["car_id"], :name => "index_car_translations_on_car_id"
  add_index "car_translations", ["locale"], :name => "index_car_translations_on_locale"
